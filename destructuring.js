...
function ingredients(object){ // ask in morning meeting about why objects in push fuct had to be restated instead of just using object
  let newIngred=[]
  const {carb,fat,protein}= object;
  newIngred.push(carb,fat,protein);
  return newIngred;
}
